...
[Admission Date],
[Discharge Date],
CPG_PrimaryDiagnosis, Specialty_at_Discharge,
ProcedureCategory,
[Primary Diagnosis],
[Primary Procedure],
Spells,
...
into ##op_admitted
from
[DIV_Perf].dbo.[CPG_Pathway_Analytics_Metrics_backup] cpg
where 
...
left(referral_id,2)+right(left(referral_id,8),3)+right(left(referral_id,4),3) as Anon_ReferralID,
...
where [Admission Date] between @StartDate and  @EndDate
